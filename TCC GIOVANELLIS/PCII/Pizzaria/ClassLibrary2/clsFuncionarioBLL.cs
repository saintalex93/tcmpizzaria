  ...
  public  class clsFuncionarioBLL
    ...
    ~clsFuncionarioBLL()
        ...
        public DataTable InsereFuncionario(clsFuncionario objPedido)
        {
            ...
            DataTable dt = Banco.ExecuteProc("CSP_Insere_Funcionario", LstParametros);
        ...
        public DataTable SelecionaFuncionario(clsFuncionario objPedido)
        {
            ...
            DataTable dt = Banco.ExecuteProc("CSharp_Select_Funcionario", LstParametros);
        ...
        public DataTable SelecionaEntregadores()
        {
            ...
            DataTable dt = Banco.ExecuteProc("USP_CSharp_Entregas_SelecionaEntregadores", LstParametros);
        ...
        public DataTable BuscarCargos()
        {
            ...
            return Banco.ExecuteProc("USP_CSharp_Funcionarios_BuscarCargos", lista);
        }
