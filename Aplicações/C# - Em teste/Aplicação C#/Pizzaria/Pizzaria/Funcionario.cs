                ...
                switch (valida)
                {
                    ...
                    */
                    ...
                    case false:
                        ...
                        if (ValidaCPF(cpf))
                        {
                            strIncluir = "insert into Funcionario (Nome,CPF_Funcionario,Endereco_Funcionario,Complemento_Funcionario,Numero_Residencia,CEP_Funcionario,Estado_Funcionario,Cidade_Funcionario ,Email_Funcionario ,Telefone_Funcionario,Celular_Funcionario ,Bairro_Funcionario) values ('" + nome + "','" + cpf + "','" + endereco + "','" + complemento + "','" + num_endereco + "','" + cep + "','" + uf + "','" + cidade + "','" + email + "','" + telefone + "','" + cel + "','" + bairro + "')";
                          ...
                          if (mtxt_cpf.Text.Replace(" ", "").Replace(".","").Replace("-","").Length == 11)
                          {
                             ...
                             cpf = mtxt_cpf.Text;
                              ...
                              if (mtxt_telefone.Text.Replace(" ", "").Length == 13)
                              {
                                  ...
                                  if (txt_numero.TextLength != 0 || txt_endereco.TextLength == 0 )
                                  {
